...
import com.xinshuwu.widget.compoment.pager.PageIndicator;
		...
		public View setView(ViewGroup container, int position, @Nullable View view) {
			...
			if (position < images.size()) {
				...
				if (image instanceof String) {
					Picasso.with(context).load((String) image).into(imageView);
				} else if (image instanceof Integer) {
					Picasso.with(context).load((int) image).into(imageView);
